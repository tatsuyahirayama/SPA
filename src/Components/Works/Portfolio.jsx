...
const Portfolio = (props) =>{
    ...
    <div className='container-introduction'>
        ...
        struggled1="・レスポンシブ設計の経験が浅く、何度もデベロッパーツールでスマホレイアウトを確認しながらコーディングを進めました。
                      "
        struggled2="・ハンバーガーメニューやアコーディオンメニューの実装にあたり、色々な記事を読み漁り実装に至りました。
                      "
        struggled3="・animate.cssやSwiper.jsなど初めて使用するツールにトライしたため、実装に苦戦。"
